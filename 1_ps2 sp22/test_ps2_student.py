...
Your total score for this game is: 18'''
        with unittest.mock.patch('builtins.input',  make_input):
            ...
            try:
                ...
                if len(lines) > 4:
                    self.assertTrue("h"+HIDDEN in lines[1], "Incorrect word progress.")
                    self.assertTrue("10 guesses" in lines[2], "Incorrect number of guesses remaining.")
                    self.assertTrue("h"+HIDDEN in lines[2], "Incorrect word progress.")
                    self.assertTrue("8 guesses" in lines[3], "Incorrect number of guesses remaining.")
                    self.assertTrue("hi" in lines[3], "Incorrect word progress.")
                    self.assertTrue("score" in lines[4], "Please include the word \'score\' when revealing final score!")
                    self.assertTrue("18" in lines[4], "Incorrect final score. Expected 18.")
                else:
...
Sorry, you ran out of guesses. The word was hi'''
        ...
        with unittest.mock.patch('builtins.input',  make_input):
            ...
            outputstr =""
            try:
                self.assertFalse(threw_exception, "test_play_game_short_fail test could not be run to completion!")
                if len(lines) > 8:
                    self.assertTrue("10 guesses" in lines[1], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN*2 in lines[1], "Incorrect word progress.")
                    self.assertTrue("9 guesses" in lines[2], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN*2 in lines[2], "Incorrect word progress.")
                    self.assertTrue("7 guesses" in lines[3], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN+"i" in lines[3], "Incorrect word progress.")
                    self.assertTrue("7 guesses" in lines[4], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN+"i" in lines[4], "Incorrect word progress.")
                    self.assertTrue("6 guesses" in lines[5], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN+"i" in lines[5], "Incorrect word progress.")
                    self.assertTrue("4 guesses" in lines[6], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN+"i" in lines[6], "Incorrect word progress.")
                    self.assertTrue("3 guesses" in lines[7], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN+"i" in lines[7], "Incorrect word progress.")
                    self.assertTrue("2 guesses" in lines[8], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN+"i" in lines[8], "Incorrect word progress.")
                    self.assertTrue("1 guess" in lines[9], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN+"i" in lines[9], "Incorrect word progress.")
                    self.assertTrue("abcdfghjoqrstvwxyz" in lines[9], "Incorrect letters remaining.")
                    self.assertTrue("hi" in lines[10], "Please reveal the answer to the player when they run out of guesses!")
...
'''
        ...
        with unittest.mock.patch('builtins.input',  make_input):
            ...
            outputstr =""
            try:
                self.assertFalse(threw_exception, "test_play_game_wildcard test could not be run to completion!")
                if len(lines) > 9:
                    self.assertTrue("10 guesses" in lines[1], "Incorrect number of guesses remaining.")
                    self.assertTrue(HIDDEN*8 in lines[1], "Incorrect word progress.")
                    self.assertTrue("9 guesses" in lines[2], "Incorrect number of guesses remaining.")
                    self.assertTrue("w"+HIDDEN*7 in lines[2], "Incorrect word progress.")
                    self.assertTrue("9 guesses" in lines[3], "Incorrect number of guesses remaining.")
                    self.assertTrue("wi"+HIDDEN*6 in lines[3], "Incorrect word progress.")
                    self.assertTrue("9 guesses" in lines[4], "Incorrect number of guesses remaining.")
                    self.assertTrue("wil"+HIDDEN*5 in lines[4], "Incorrect word progress.")
                    self.assertTrue("9 guesses" in lines[5], "Incorrect number of guesses remaining.")
                    self.assertTrue("wild"+HIDDEN*3+"d" in lines[5], "Incorrect word progress.")
                    self.assertTrue("9 guesses" in lines[6], "Incorrect number of guesses remaining.")
                    self.assertTrue("wildc"+HIDDEN*2+"d" in lines[6], "Incorrect word progress.")
                    self.assertTrue("9 guesses" in lines[7], "Incorrect number of guesses remaining.")
                    self.assertTrue("revealed" in lines[7], "Incorrect word progress.") # lost 3 guesses
                    self.assertTrue("6 guesses" in lines[8], "Incorrect number of guesses remaining.")
                    self.assertTrue("revealed" in lines[8], "Incorrect word progress.") # lost 3 guesses
                    self.assertTrue("score" in lines[9], "Please include the word \'score\' when revealing the final score!")
                    self.assertTrue("41" in lines[9], "Incorrect final score. Expected 41.")
                else:
                    self.assertTrue(False)
            except Exception as e:
